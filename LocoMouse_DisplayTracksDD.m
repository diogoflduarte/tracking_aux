...
% Last Modified by GUIDE v2.5 26-Sep-2017 17:59:02
...
% --- Executes on button press in checkboxFL.
function checkboxFL_Callback(hObject, eventdata, handles)
% hObject    handle to checkboxFL (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of checkboxFL
switch hObject.Value
    case 0
        set(handles.plot_handles([1 2],3),'visible','off');
    case 1
        set(handles.plot_handles([1 2],3),'visible','on');
end



% --- Executes on button press in checkboxFR.
function checkboxFR_Callback(hObject, eventdata, handles)
% hObject    handle to checkboxFR (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of checkboxFR
switch hObject.Value
    case 0
        set(handles.plot_handles([1 2],1),'visible','off');
    case 1
        set(handles.plot_handles([1 2],1),'visible','on');
end
...
switch hObject.Value
    case 0
        set(handles.plot_handles([1 2],4),'visible','off');
    case 1
        set(handles.plot_handles([1 2],4),'visible','on');
end

% --- Executes on button press in checkboxHR.
function checkboxHR_Callback(hObject, eventdata, handles)
% hObject    handle to checkboxHR (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of checkboxHR
switch hObject.Value
    case 0
        set(handles.plot_handles([1 2],2),'visible','off');
    case 1
        set(handles.plot_handles([1 2],2),'visible','on');
end

% --- Executes on button press in checkboxsnout.
function checkboxsnout_Callback(hObject, eventdata, handles)
% hObject    handle to checkboxsnout (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of checkboxsnout
switch hObject.Value
    case 0
        set(handles.plot_handles([1 2],5),'visible','off');
    case 1
        set(handles.plot_handles([1 2],5),'visible','on');
end

% --- Executes on button press in checkboxtail.
function checkboxtail_Callback(hObject, eventdata, handles)
% hObject    handle to checkboxtail (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of checkboxtail
switch hObject.Value
    case 0
        set(handles.plot_handles_tail(:,:),'visible','off');
    case 1
